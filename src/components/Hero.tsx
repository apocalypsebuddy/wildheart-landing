...
import LeopardHero from "../../public/img/WFSnowLeopardHero.jpg";

export const Hero = () => {
  return (
    <>
      <div className="relative">
        <Container className="relative flex flex-wrap items-center 2xl:my-36 xl:my-14 lg:px-24 lg:py-24 sm:p-2 min-h-[60vh]">
          <div className="z-10 w-full md:w-1/2 xl:pl-8 md:pl-4 mb-12">
            <div className="max-w-2xl mb-8">
              <h1 className="text-4xl font-bold leading-snug tracking-tight lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight text-white">
                {/* TODO: use span to change color of "wild" to theme color */}
                Helping wildlife feel wild again
              </h1>
              <p className="p-3 my-2 text-xl leading-normal text-gray-100 lg:text-xl xl:text-2xl bg-black/40 [text-shadow:_0_4px_6px_rgba(0,0,0,0.75)]">
                The WildHeart Foundation works with zoos and animal sanctuaries to
                improve the quality of life for wild animals in their care.
              </p>
      ...
      {/* <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            WildHeart has provided for zoo animals around the world
          </div>

          TODO: Grab logos from various organizations (Denver Zoo, Cheyenne Mountain Zoo, Tangyanika Wildlife Park, Thailand Dept of Wildlife, Emirates Park Zoo)
